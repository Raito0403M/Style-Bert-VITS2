...
class BuzzLightyearRobotFastest:
    def __init__(self):
        ...
        self.whisper_model = WhisperModel("base", device="cuda" if os.getenv("USE_GPU", "true").lower() == "true" else "cpu", compute_type="float16")
...
if __name__ == "__main__":
    print("Buzz Lightyear Robot FASTEST Server")
    print("最速版：Style-Bert-VITS2を直接インポートして使用")
    print("エンドポイント:")
